...
export const MainCard = () => {
  ...
  useEffect(() => {
    let get = JSON.parse(localStorage.getItem("invited")!);
    let getLast = get[get.length - 1];
    setUserState(getLast);
      ...
      <Container>
        <Card key={userState?.phone}>
          ...
          <Title>
            ...
            <Time>
              <div>
                <AiOutlineClockCircle onClick={count} /> <p>{statee}</p>
              </div>
              <p>
                <Icon>
                  <AiFillHeart />
